...
import { Alert, Dimensions, Pressable, SafeAreaView, ScrollView, StyleSheet, Switch, Text, TextInput, TouchableOpacity, View } from 'react-native';
      ...
      items: [
        {
          ...
          description: 'Create, view, and manage vault keys',
          icon: '🔑',
          type: 'link' as const,
          onPress: () => router.push('/(main)/settings/encryption-keys'),
        },
      ] as SettingItem[],
    },
  ];
